...
def make_net(phase='train'):
  ...
  ##
  n.fc3_1 = L.InnerProduct(n.relu3, num_output=128, bias_term=True, weight_filler=dict(type='xavier'),
    param=[dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)])
  n.fc3_2 = L.InnerProduct(n.fc3_1, num_output=64, bias_term=True, weight_filler=dict(type='xavier'),
    param=[dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)])
  n.relu3_2 = L.ReLU(n.fc3_2, in_place=True)
  n.drop3_2 = L.Dropout(n.relu3_2, dropout_ratio=0.5, in_place=True)

  n.fc4_1 = L.InnerProduct(n.relu4, num_output=128, bias_term=True, weight_filler=dict(type='xavier'),
    param=[dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)])
  n.fc4_2 = L.InnerProduct(n.fc4_1, num_output=64, bias_term=True, weight_filler=dict(type='xavier'),
    param=[dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)])
  n.relu4_2 = L.ReLU(n.fc4_2, in_place=True)
  n.drop4_2 = L.Dropout(n.relu4_2, dropout_ratio=0.5, in_place=True)
  ##
  ...
  ## Concat
  n.concat = L.Concat(n.drop3_2, n.drop4_2, n.drop7)
  ## 
  if args.nout > 0:
  ...
  n.fc8 = L.InnerProduct(n.concat, num_output=nout, bias_term=True, weight_filler=dict(type='xavier'),
